...
export default function BackgroundMusic() {
    ...
    useEffect(() => {
        ...
        // Try to play automatically if it was playing or just on load
        ...
        if (wasPlaying) {
            ...
            // Optional: Auto-play even if not previously playing? 
            // The user said "Lagu tetap otomatis berjalan", so let's try to autoplay always.
            playAudio();
        }
